          ...
          for (x in accountTransactions) {
            for (y in clientNote) {
              var productData = {
                ...
                id: res.result[key].accountTransactions[x].id,
                operationDate: res.result[key].accountTransactions[x].operationDate,
                valueDate: res.result[key].accountTransactions[x].valueDate,
                amount: res.result[key].accountTransactions[x].amount,
                currency: res.result[key].accountTransactions[x].currenty,
                description: res.result[key].accountTransactions[x].description,
                categoryId: res.result[key].accountTransactions[x].category.id,
                categoryName: res.result[key].accountTransactions[x].category.name,
                subcategoryId: res.result[key].accountTransactions[x].subCategory.id,
                subcategoryName: res.result[key].accountTransactions[x].subCategory.name,
                clientText: res.result[key].accountTransactions[x].clientNote[y].text,
                clientDate: res.result[key].accountTransactions[x].clientNote[y].date,
                attachedName: res.result[key].accountTransactions[x].attachedInfo[y].name,
                attachedType: res.result[key].accountTransactions[x].attachedInfo[y].type,
                attachedSize: res.result[key].accountTransactions[x].attachedInfo[y].size,
                attachedDate: res.result[key].accountTransactions[x].attachedInfo[y].date
              };
